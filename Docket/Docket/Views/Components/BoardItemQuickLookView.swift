...
/// The lifted item on the long-press surface: enough to scan without opening
/// the detail page.
struct BoardItemQuickLookView: View {
    enum Style {
        case full
        /// Category, status, and title only. For an item lifted alongside its
        /// own artwork, where a second panel is already carrying everything
        /// this one would repeat.
        case title
    }
